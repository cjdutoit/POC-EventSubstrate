...
namespace StudentApp.Core.Tests.Unit.Services.Foundations.Students
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRetrieveByIdIfIdIsEmptyAsync()
        {
            // given
            ...
            ValueTask<Student> retrieveStudentByIdTask =
                this.studentService.RetrieveStudentByIdAsync(emptyStudentId);
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRetrieveByIdIfStudentNotFoundAsync()
        {
            // given
